...
export function buildSubmissionAuditEvent(input: {
  ...
  return {
    ...
    agent: [
      {
        who: { display: "Overturn synthetic approval executor" },
        requestor: true,
      },
    ],
    source: {
      observer: { display: "Overturn demo" },
    },
    entity: [
      {
    ...
    agent: [
      {
        ...
        who: { display: "Overturn synthetic agent" },
      },
      {
        type: {
          coding: [
...
export function buildAppealProvenance(input: {
  episodeId: string;
  claimId: string;
  artifactId: string;
  receiptId: string;
  ...
  return {
    ...
    activity: {
      ...
      text: `Formal appeal submitted to fictional Northstar payer portal (confirmation ${input.confirmationNumber})`,
    },
    agent: [
      {
        type: {
...
export function buildAppealAuditEvent(input: {
  episodeId: string;
  claimId: string;
  artifactId: string;
  receiptId: string;
  ...
  return {
    ...
    entity: [
      ...
      {
        what: { reference: input.artifactId },
        description: "Formal appeal packet artifact",
      },
      {
        what: { reference: `ClaimResponse/${input.receiptId}` },
        description: `Northstar portal appeal confirmation ${input.confirmationNumber}`,
      },
    ],
  };
}
